...
public class Createprofile extends javax.swing.JFrame {
 ...
 String user;
    public Createprofile() {
        ...
        jLabel5.setText(user+"'s Profile :");
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel4.setText("Qualifiaction");

        g.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "SELECT ANY", "MALE", "FEMALE", "OTHER" }));

        t1.setBackground(new java.awt.Color(102, 102, 102));
        t1.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.DateFormatter(new java.text.SimpleDateFormat("yyyy-M-d"))));
        ...
        jLabel5.setText(" ");
        jLabel5.setBorder(javax.swing.BorderFactory.createMatteBorder(5, 3, 5, 3, new java.awt.Color(204, 0, 0)));

        jLabel2.setText("Contact No.");

        t3.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("##########"))));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
                ...
                try
        {
             ...
             Class.forName("com.mysql.jdbc.Driver");//load this class 
          Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/coerlogin","root","");
          PreparedStatement stmt=conn.prepareStatement("insert into profile(gender,dob,qualifications,phone_no,uname)  values(?,?,?,?,?);");
         
          String ge=g.getSelectedItem().toString();
          String a=t1.getText();
          String b=t2.getText();
          String c=t3.getText();
          ...
          if(stmt.executeUpdate()==1){
              JOptionPane.showMessageDialog(rootPane, "Changes Saved to Profile !");
          }
        ...
        {
            JOptionPane.showMessageDialog(rootPane, "Please enter a Valid Contact no.!");
        }
